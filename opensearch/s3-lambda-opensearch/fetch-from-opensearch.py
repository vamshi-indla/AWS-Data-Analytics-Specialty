#source: https://github.com/linuxacademy/Content-AWS-Certified-Data-Analytics---Speciality/blob/master/Lab_Assets/implementing_an_elasticsearch_backed_search_microservice/function_solved.py
import boto3
import json
...
def query_es(query_term):
    es = Elasticsearch(
        [{'host': 'https://search-frankensearch-v3qbi623zlqbpd4yw7oj5oqi3q.us-east-1.es.amazonaws.com', 'port': 443, 'use_ssl': True}],
